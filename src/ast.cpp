...
void
DeclVar::compile(vector<Code>& ofs, map<string, int>& vars,
...
void
DeclArrayVar::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    if (!vars[_id]) {
...
void
InitializedDeclArrayVar::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    if (!vars[_id]) {
        DeclVar::compile(ofs, vars, functions, offset);
        ofs.push_back(Code::makeCode(Code::PUSHR, 2, 0));
...
void
DeclVarSt::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
...
void
IfSt::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    int jumpToElse;
    int jumpFromTrue;
...
void
WhileSt::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    int jumpToBottom = 0;
...
void
ForSt::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    int jumpToBottom = 0;
...
void
Block::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    for (Statement *statement : _statements) {
...
void
CallFuncSt::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    if (_args.size() > 0) {
        for (auto arg : _args) {
...
void
Function::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    vars.clear();
    vars["."] = 0;
...
void
ImportFunction::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
...
void
ReturnSt::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
...
void
ExpressionSt::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _exp->compile(ofs, vars, functions, offset);
}
...
void
Assign::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
...
void
AddExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
...
void
AddExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
...
void
SubExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->compile(ofs, vars, functions, offset);
    _right->compile(ofs, vars, functions, offset);
    ofs.push_back(Code::makeCode("POP 3 0"));
...
void
SubExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->lcompile(codes, vars, functions, offset);
    _right->lcompile(codes, vars, functions, offset);
    codes.push_back(Code::makeCode("POP 3 0"));
...
void
MulExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->compile(ofs, vars, functions, offset);
    _right->compile(ofs, vars, functions, offset);
    ofs.push_back(Code::makeCode(Code::POP, 2, 0));
...
void
MulExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->lcompile(codes, vars, functions, offset);
    _right->lcompile(codes, vars, functions, offset);
    codes.push_back(Code::makeCode("POP 3 0"));
...
void
DivExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->compile(ofs, vars, functions, offset);
    _right->compile(ofs, vars, functions, offset);
    ofs.push_back(Code::makeCode("POP 3 0"));
...
void
DivExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->lcompile(codes, vars, functions, offset);
    _right->lcompile(codes, vars, functions, offset);
    codes.push_back(Code::makeCode("POP 3 0"));
...
void
ModExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->compile(ofs, vars, functions, offset);
    _right->compile(ofs, vars, functions, offset);
    ofs.push_back(Code::makeCode("POP 3 0"));
...
void
ModExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->lcompile(codes, vars, functions, offset);
    _right->lcompile(codes, vars, functions, offset);
    codes.push_back(Code::makeCode("POP 3 0"));
...
void
EQExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->compile(ofs, vars, functions, offset);
    _right->compile(ofs, vars, functions, offset);
    ofs.push_back(Code::makeCode("POP 3 0"));
...
void
EQExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->lcompile(codes, vars, functions, offset);
    _right->lcompile(codes, vars, functions, offset);
    codes.push_back(Code::makeCode("POP 3 0"));
...
void
NEExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->compile(ofs, vars, functions, offset);
    _right->compile(ofs, vars, functions, offset);
    ofs.push_back(Code::makeCode("POP 3 0"));
...
void
NEExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->lcompile(codes, vars, functions, offset);
    _right->lcompile(codes, vars, functions, offset);
    codes.push_back(Code::makeCode("POP 3 0"));
...
void
LTExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->compile(ofs, vars, functions, offset);
    _right->compile(ofs, vars, functions, offset);
    ofs.push_back(Code::makeCode("POP 3 0"));
...
void
LTExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->lcompile(codes, vars, functions, offset);
    _right->lcompile(codes, vars, functions, offset);
    codes.push_back(Code::makeCode("POP 3 0"));
...
void
LEExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->compile(ofs, vars, functions, offset);
    _right->compile(ofs, vars, functions, offset);
    ofs.push_back(Code::makeCode("POP 3 0"));
...
void
LEExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->lcompile(codes, vars, functions, offset);
    _right->lcompile(codes, vars, functions, offset);
    codes.push_back(Code::makeCode("POP 3 0"));
...
void
GTExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->compile(ofs, vars, functions, offset);
    _right->compile(ofs, vars, functions, offset);
    ofs.push_back(Code::makeCode("POP 3 0"));
...
void
GTExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->lcompile(codes, vars, functions, offset);
    _right->lcompile(codes, vars, functions, offset);
    codes.push_back(Code::makeCode("POP 3 0"));
...
void
GEExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->compile(ofs, vars, functions, offset);
    _right->compile(ofs, vars, functions, offset);
    ofs.push_back(Code::makeCode("POP 3 0"));
...
void
GEExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _left->lcompile(codes, vars, functions, offset);
    _right->lcompile(codes, vars, functions, offset);
    codes.push_back(Code::makeCode("POP 3 0"));
...
void
IntExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    ofs.push_back(Code::makeCode("PUSHI " + to_string(_int_val) + " 0"));
}

void
IntExp::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
...
void
ArrayIndex::compile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
...
void
ArrayIndex::lcompile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
...
void
Address::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    _exp->lcompile(ofs, vars, functions, offset);
}

void
Address::lcompile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    print(cerr, 0);
...
void
Access::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
...
void
Access::lcompile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
...
void
Variable::compile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    try {
...
void
Variable::lcompile(vector<Code>& codes, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    try {
        codes.push_back(Code::makeCode(Code::MOVE, 2, 0));
        codes.push_back(Code::makeCode(Code::PUSHI, vars.at(_id), 0));
...
void
CallFuncExp::compile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    if (_args.size() > 0) {
        for (auto arg : _args) {
            arg->compile(ofs, vars, functions, offset);
...
void
CallFuncExp::lcompile(vector<Code>& ofs, map<string, int>& vars,
    map<string, int>& functions, int offset) {
    print(cerr, 0);
    throw CompileError("can't use as left side");
}
